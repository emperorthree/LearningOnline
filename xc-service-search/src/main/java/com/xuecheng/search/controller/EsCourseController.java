...
public class EsCourseController implements EsCourseSearchControllerApi {
    ...
    public Map<String, CoursePub> getAllById(@PathVariable("id") String id) {
        return esCourseService.getAllById(id);
    }
    ...
    public TeachplanMediaPub getMedia(@PathVariable("teachplanId") String teachplanId) {
        ...
        QueryResult<TeachplanMediaPub> queryResult = media.getQueryResult();
