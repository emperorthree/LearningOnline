...
public enum CourseCode implements ResultCode {
    ...
    COURSE_MEDIS_TEACHPLAN_GRADE_ERROR(false,31104,"媒资文件的课程计划层级错误！"),
    COURSE_CREATE_INDEX_FILE(false,31106,"添加课程索引发布信息失败!"),
    COURSE_MEDIA_TEACHPLAN_ISNULL(false, 31103, "媒体文件的课程计划为空!");
